...
{_T( "Boost" ), REGEX_COMPATIBILITY_BOOST, REGEX_SUBSET_BOOST | REGEX_SUBSET_DOLLAR_PREFIX_ONLY, TRUE, "Boost", "Default boost regex with flag regex_constants::format_default", RGB_Orange},
{_T( "Boost (default) Multiline" ), REGEX_COMPATIBILITY_BOOST_DEFAULT_MULTILINE, (REGEX_SUBSET_BOOST | REGEX_SUBSET_MULTILINE | REGEX_SUBSET_DOLLAR_PREFIX_ONLY), TRUE, "BoostDefaultMultiline", "Boost with multiline set", RGB_Orange},
...
{_T( "C++ Regex" ), REGEX_COMPATIBILITY_CPP, REGEX_SUBSET_STD_REGEX | REGEX_SUBSET_DOLLAR_PREFIX_ONLY, TRUE, "C++", "C++ STD Regex", RGB_Orange},
{_T( "ECMAScript" ), REGEX_COMPATIBILITY_ECMAScript, REGEX_SUBSET_STD_REGEX | REGEX_SUBSET_DOLLAR_PREFIX_ONLY, TRUE, "ECMAScript", "ECMAScript via C++ Regex", RGB_Orange},
...
{_T( "POSIX_ERE" ), REGEX_COMPATIBILITY_POSIX_ERE, (REGEX_SUBSET_SCINTILLA | REGEX_SUBSET_POSIX | REGEX_SUBSET_BACKSLASH_PREFIX_ONLY), NOT_IMPLEMENTED}, //DO CONVERSIONS ON POSIX CLASS with Scentilla POSIX
{_T( "POSIX_BRE" ), REGEX_COMPATIBILITY_POSIX_BRE, (REGEX_SUBSET_SCINTILLA | REGEX_SUBSET_UNIX_OLD_SYNTAX | REGEX_SUBSET_BACKSLASH_PREFIX_ONLY), TRUE, "", "Old UNIX style regex", RGB_YELLOW},
...
const CString CRegexAssistantDlg::InsertItemsList[] =
{
	...
	INSERT_ITEMS_LIST( "Matches either the expression before or after",					"|", "abc|def", "abc, def" ),
	INSERT_ITEMS_LIST( "Beginning of a line",											"^", "^foo\\S*", "foolery, footlights" ),
	INSERT_ITEMS_LIST( "End of a line",													"$", "\\S*com$", "http://foolhardy.com" ),
	INSERT_ITEMS_LIST( "#Beginning of a word",											"\\<", "\\<foot", "footage, football, footloose" ),
	INSERT_ITEMS_LIST( "#End of a word",												"\\>", "ch\\>", "beach, which" ),
	...
	INSERT_ITEMS_LIST( "A letter, digit, or underscore. Same as [A-Za-z0-9_]",			"\\w", "cat\\wfood", "cat8food, cat_food, catQfood, catifood" ),
	INSERT_ITEMS_LIST( "Exludes letters, digits, & underscore. Same as [^A-Za-z0-9_]",	"\\W", "cat\\Wfood", "cat food, cat&food, cat-food, cat.food" ),
	...
	INSERT_ITEMS_LIST( "1 or more character(s), no white space",						"\\w+", "\\w+", "abc, defg, foo3, foo_123" ),
	INSERT_ITEMS_LIST( "Single digit",													"[0-9]", "cat[0-9]ood", "cat3ood, cat8ood, cat2ood, ..." ),
	INSERT_ITEMS_LIST( "Single letter",													"[a-zA-Z]", "cat[a-zA-Z]ood", "catfood, catHood, catwood" ),
	INSERT_ITEMS_LIST( "Single lowercase letter",										"[a-z]", "cat[a-z]ood", "catfood, cathood, catwood" ),
	INSERT_ITEMS_LIST( "Single uppercase letter",										"[A-Z]", "cat[A-Z]ood", "catFood, catHood, catWood" ),
	INSERT_ITEMS_LIST( "Single letter or digit",										"[0-9a-zA-Z]", "cat[0-9a-zA-Z]ood", "cat5ood, cathood, catWood" ),
